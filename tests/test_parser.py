...
def test_empty():
    parser = ModelParser(start="empty")
    parsed_empty = parser.parse("")
    assert parsed_empty is None


def test_model():
    parser = ModelParser(start="model")
...
def test_sections():
    parser = ModelParser(start="sections")
...
def test_section_1():
    parser = ModelParser(start="section_1")
...
def test_section_2():
    parser = ModelParser(start="section_2")
...
def test_delimited_identifiers():
    parser = ModelParser(start="delimited_identifiers")
...
def test_identifier():
    parser = ModelParser(start="identifier")
...
def test_statements():
    parser = ModelParser(start="statements")
...
def test_statement():
    parser = ModelParser(start="statement")
...
def test_expression():
    parser = ModelParser(start="expression")
...
def test_variable():
    parser = ModelParser(start="variable")
...
def test_parenthesized_expression():
    parser = ModelParser(start="parenthesized_expression")
...
def test_ternary_expression():
    parser = ModelParser(start="ternary_expression")
...
def test_condition():
    parser = ModelParser(start="condition")
...
def test_mathematical_expression():
    parser = ModelParser(start="mathematical_expression")
    parsed_expression = parser.parse("a + b")
    expected_expression = MathematicalExpression(
        operator="+", lhs=Identifier(name="a"), rhs=Identifier(name="b")
    )
...
def test_number():
    parser = ModelParser(start="number")
...
def test_readme(data_path):
    model = (data_path / "pred_prey.model").read_text()
    parser = ModelParser()
    # this file should be parsable without error
    parser.parse(model)
